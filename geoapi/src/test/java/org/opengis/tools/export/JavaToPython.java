...
//                          collection = "Set";                     // TODO: needs to manage imports
     ...
     */
    @Test
    @Ignore("Python interfaces should be generated by GeoAPI 4.0. Since those interfaces did not existed"
            + " in GeoAPI 3.0, they should not be impacted by the historical constraints of GeoAPI 3.1.")
