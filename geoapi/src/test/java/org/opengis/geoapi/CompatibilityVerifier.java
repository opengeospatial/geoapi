 ...
 *    Copyright © 2014-2025 Open Geospatial Consortium, Inc.
 *    http://www.geoapi.org
 *
 ...
 * This test class provides a {@link #listChanges()} method which lists new methods
 * and methods having an incompatible change. This is used for generating the list
...
public class CompatibilityVerifier implements Closeable {
     ...
     */
    CompatibilityVerifier(final String oldVersion, final String newVersion) throws MalformedURLException {
        final File mavenRepository = new File(System.getProperty("user.home"), ".m2/repository");
        final ClassLoader parent = CompatibilityVerifier.class.getClassLoader().getParent();
     ...
     * {@link CompatibilityTest#verifyCompatibility()} since adding new methods are compatible changes.
     * This method is used only by {@link #listChanges()} as part of the release notes.
     *
