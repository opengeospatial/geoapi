...
public final class Sequence extends CodeList<Sequence> {
     ...
     */
    private static final List<Sequence> VALUES = initialValues(
        // Inline assignments for getting compiler error if a field is missing or duplicated.
        START         = new Sequence("START"),
        END           = new Sequence("END"),
        INSTANTANEOUS = new Sequence("INSTANTANEOUS"));
    ...
    public static Sequence valueOf(String code) {
        return valueOf(VALUES, code, Sequence::new);
    }
}
