...
public final class ImagingCondition extends CodeList<ImagingCondition> {
     ...
     */
    private static final List<ImagingCondition> VALUES = initialValues(
        // Inline assignments for getting compiler error if a field is missing or duplicated.
        BLURRED_IMAGE       = new ImagingCondition("BLURRED_IMAGE"),
        CLOUD               = new ImagingCondition("CLOUD"),
        DEGRADING_OBLIQUITY = new ImagingCondition("DEGRADING_OBLIQUITY"),
        FOG                 = new ImagingCondition("FOG"),
        HEAVY_SMOKE_OR_DUST = new ImagingCondition("HEAVY_SMOKE_OR_DUST"),
        NIGHT               = new ImagingCondition("NIGHT"),
        RAIN                = new ImagingCondition("RAIN"),
        SEMI_DARKNESS       = new ImagingCondition("SEMI_DARKNESS"),
        SHADOW              = new ImagingCondition("SHADOW"),
        SNOW                = new ImagingCondition("SNOW"),
        TERRAIN_MASKING     = new ImagingCondition("TERRAIN_MASKING"));
    ...
    /**
     * Returns the imaging condition that matches the given name, or returns a new value if there is no match.
    ...
    public static ImagingCondition valueOf(String code) {
        return valueOf(VALUES, code, ImagingCondition::new);
    }
}
