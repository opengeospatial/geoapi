...
public final class Datatype extends CodeList<Datatype> {
     ...
     */
    private static final List<Datatype> VALUES = initialValues(
        // Inline assignments for getting compiler error if a field is missing or duplicated.
        CLASS             = new Datatype("CLASS"),
        CODE_LIST         = new Datatype("CODE_LIST"),
        ENUMERATION       = new Datatype("ENUMERATION"),
        CODE_LIST_ELEMENT = new Datatype("CODE_LIST_ELEMENT"),
        ABSTRACT_CLASS    = new Datatype("ABSTRACT_CLASS"),
        AGGREGATE_CLASS   = new Datatype("AGGREGATE_CLASS"),
        SPECIFIED_CLASS   = new Datatype("SPECIFIED_CLASS"),
        DATATYPE_CLASS    = new Datatype("DATATYPE_CLASS"),
        INTERFACE_CLASS   = new Datatype("INTERFACE_CLASS"),
        UNION_CLASS       = new Datatype("UNION_CLASS"),
        META_CLASS        = new Datatype("META_CLASS"),
        TYPE_CLASS        = new Datatype("TYPE_CLASS"),
        CHARACTER_STRING  = new Datatype("CHARACTER_STRING"),
        INTEGER           = new Datatype("INTEGER"),
        ASSOCIATION       = new Datatype("ASSOCIATION"));
    ...
    public static Datatype valueOf(String code) {
        return valueOf(VALUES, code, Datatype::new);
    }
}
