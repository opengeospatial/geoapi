...
/**
 * Indicating an implementation of a operation type for a specific type.
 * <p>
 * This class carries the ComplexType specific information requried
 * for using an operation. Name, type and evaulation are defined.
 * <p>
 ...
 */
public interface OperationDescriptor<B, T extends AttributeType<B>, O extends OperationType<B,T>> extends PropertyDescriptor {
	 ...
	 * modeling a schema where the operations are only available when the information
	 * is executed on a remote web processing service. We still need to track the
	 * operations, even those we cannot execute them in the current environment.
	 * </p>
	 ...
	 * <p>
	 * The state of the operation may be used and / or updated during
	 ...
	 * calling invoke.
	 * 
	 * @param anAttribute This is the attribute used for context when evaulating the operation
	 * @param params
