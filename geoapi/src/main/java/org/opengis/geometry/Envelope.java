 ...
 *
 * <div class="note"><p><b>Spanning the anti-meridian of a geographic CRS</b><br>
...
public interface Envelope {
     ...
     * bottom of the map even if the left corner became the right corner.</p></div>
     *
     ...
     * top of the map even if the right corner became the left corner.</p></div>
     *
     ...
     * value, at implementor choice.</p></div>
     *
     ...
     * median value is inside the axis range.</p></div>
     *
     * @param  dimension  the dimension for which to obtain the ordinate value.
     ...
     *
     * <p>Implementations are free to use variants of the above algorithm. For example some
     * libraries may add different multiples of the periodicity.</p></div>
     *
