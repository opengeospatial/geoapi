...
/**
 * <code>DisplayFactoryManager</code> defines static variables and methods
 * used to access the application's <code>DisplayFactory</code>
 * implementation(s).
 * <P>
 * The default <code>DisplayFactory</code> implementation may be overridden in
 * one of two ways: by setting the system property
 * <code>org.ogc.go1.DisplayFactoryClass</code> to the fully qualified name of
 * a class that implements <code>DisplayFactory</code> (using the "-D" option
...
public class DisplayFactoryManager {
    ...
    static {
        try {
            ...
            displayFactory = (org.opengis.go.display.DisplayFactory)dfClass.newInstance();
     ...
     * className. If that particular type of <code>DisplayFactory</code> has
     * not been created, then a new instance will be instantiated.
     * 
     * @param displayFactoryProps the class name of the requested
     *        <code>DisplayFactory</code>. Class name property name is "
     *        <code>DISPLAY_FACTORY_NAME</code>".
     */
    ...
    throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        DisplayFactory factory = (DisplayFactory)Class.forName(className).newInstance();
