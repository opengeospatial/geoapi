...
public interface TemporalPosition {
    ...
    /**
     * Get the Temporal ReferenceSystem
     * 
     * @return TemporalReferenceSystem instance
     */
    public TemporalReferenceSystem getTemporalReferenceSystem();
    
    public TemporalIndeterminateValue getTemporalIndeterminatePosition();
}
