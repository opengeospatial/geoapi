...
final class RasterMetadata extends GridGeometry implements Metadata, MetadataScope, Identification, Citation, CoverageDescription {
    ...
    @Override public Collection<String>                       getCredits()                         {return emptySet();}
    @Override public Collection<Progress>                     getStatus()                          {return emptySet();}
    @Override public Collection<ResponsibleParty>             getPointOfContacts()                 {return emptySet();}
    ...
    @Override public Collection<ResponsibleParty>             getCitedResponsibleParties()         {return emptySet();}
