...
public interface Point extends Primitive {
     ...
     * (from which a <code>DirectPosition</code> may be obtained). By not allowing <code>Point</code>
     ...
     * <br><br>
     * <strong>NOTE:</strong> In most cases, the state of a <code>Point</code> is fully determined
     * by its position attribute. The only exception to this is if the <code>Point</code> has been
     * subclassed to provide additional non-geometric information such as symbology.
     *
     * @return The direct position.
     * @UML operation position
     */
     ...
     * to the curve between this <code>Point</code> and a passed <code>Position</code>.
