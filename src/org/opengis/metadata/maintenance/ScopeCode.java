...
/// @UML (identifier="fieldSession", obligation=CONDITIONAL)
     ...
     */
/// @UML (identifier="software", obligation=CONDITIONAL)
     ...
     * a use case.
     */
/// @UML (identifier="service", obligation=CONDITIONAL)
     ...
     */
/// @UML (identifier="model", obligation=CONDITIONAL)
