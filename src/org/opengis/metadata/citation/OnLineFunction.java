...
public final class OnLineFunction extends CodeList {
     ...
     */
/// @UML (identifier="download", obligation=CONDITIONAL)
    public static final OnLineFunction DOWNLOAD = new OnLineFunction("DOWNLOAD");

    /**
     * Online information about the resource.
     */
/// @UML (identifier="information", obligation=CONDITIONAL)
     ...
     */
/// @UML (identifier="offlineAccess", obligation=CONDITIONAL)
     ...
     */
/// @UML (identifier="order", obligation=CONDITIONAL)
     ...
     */
/// @UML (identifier="search", obligation=CONDITIONAL)
