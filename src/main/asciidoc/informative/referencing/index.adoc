...
(notably the location of `coordinateSystem` association and the inclusion of `MathTransform` interface)
are discussed in following sections and in the <<referencing-departures,departures section>>.
...
The mapping of ISO 19111 packages to GeoAPI packages is as below:
...
include::coordinate-system.adoc[]
