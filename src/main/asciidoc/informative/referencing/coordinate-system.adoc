[[coordinate-system]]
==== Coordinate system
[.reference]_From ISO 19111:2019 §10_
...
None of the standard types describe the space geometry, and implementers do not need to define a public type.
...
Requesting elements in that list can be thought as redirection.
...
Since some form of coordinate system is defined for both `SingleCRS` and `CompoundCRS` interfaces,
