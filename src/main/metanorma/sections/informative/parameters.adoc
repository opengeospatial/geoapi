[[parameters]]
==== Parameters
_From <<ISO19111>> §12.2, <<ISO19115-1>> §6.5.12, <<ISO19157>> §C.2.2.4_
...
object that implements both the `International­String` and `Description` interfaces.
...
`OperationParameter` has been renamed to `ParameterDescriptor`
