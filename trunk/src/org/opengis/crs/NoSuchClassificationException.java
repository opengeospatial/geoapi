...
/**
 * Thrown when a {@linkplain org.opengis.crs.operation.MathTransform math transform}
 * was requested with an unknow classification name.
 *
 * @author <A HREF="http://www.opengis.org">OpenGIS&reg; consortium</A>
 * @version 1.0
 *
 * @see org.opengis.crs.operation.MathTransformFactory#createParameterizedTransform
 */
