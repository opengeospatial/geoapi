...
/**
 * <code>RangeBearing</code> defines the position of one object with respect
 * to the position of another object, using a measurement of linear range and
 * angle bearing.
 * <p>
 * An instance of <code>RangeBearing</code> is referenced to a Derived
 * Coordinate Reference System. The origin of the Derived Coordinate Reference
 * System is the position of the other object. The position value of
 * <code>RangeBearing</code> is computed relative to the origin of the Derived
 * Coordinate Reference System, and therefore with respect to the position of
 * the other object.
 * <p>
 * The range is defined to be the length of the path line the path, as specified
 * by the PathType parameter.
 * 
...
public class RangeBearing implements DirectPosition {
     ...
     */
    // TODO: Fix the default value. This should be an Derived Coordinate
    // Reference System of type Engineering.
    ...
    //*************************************************************************
    /**
     * Initializes range, bearing, and Coordinate Reference System to the
     * supplied parameters.
     * 
    ...
    /**
     * Returns true if the given object is a RangeBearing object, and has range
     * and bearing values and a Coordinate Reference System equal to this one.
     * 
    ...
    /**
     * Returns true if the given RangeBearing has range and bearing values and a
