...
public class UnprojectedPathType extends PathType {
     ...
     */
    private static final UnprojectedPathType[] enumList = { PIXEL_STRAIGHT, CONTINUOUS_SPLINE };
     ...
     *         given value.
     */
    public SimpleEnumerationType getByValue(int value) throws NoSuchEnumerationException {
