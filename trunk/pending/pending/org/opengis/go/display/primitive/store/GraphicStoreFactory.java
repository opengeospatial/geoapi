...
public interface GraphicStoreFactory {
     ...
     * The returned GraphicStore may not have been previously cached, though it
     * may be cached after it is instantiated.
     * <p>
     * Additional hints or configuration information may be provided according
     * to the metadata indicated by getParametersInfo. This information often
     * includes security information such as username and password.
     ...
     *            to
     * @param params Map of hints or configuration information.
     * @return GraphicStore Datastore connected to the newly created provider or
     *         serivce.
     * @throws IOException
     */
     ...
     * provider or service.
     * <p>
     * This method should not fail, if a connection needs to be made to parse a
     * GetCapabilities file or negotiate WMS versions any IO problems simply
     * indicate the inabiity to process.
     * </p>
     * <p>
     * This method may be considered the same as: canProcess( provider, hints )
     * where hints was generated by using all the default values specified by
