 ...
 * EPSG database.
 * <p>
 * This class is not actually a JUnit test. It is rather a tool which need to be executed
 * when the Proj.4 "{@code epsg}" definition file has been changed. The file generated by
 * this tools shall be moved manually to the project
 * {@code geoapi-proj4/src/main/resources/org/opengis/wrapper/proj4/} directory.
 *
