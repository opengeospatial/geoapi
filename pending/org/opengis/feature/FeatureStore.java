...
public interface FeatureStore {
     ...
     * </p>
     * <p>
     * It is too much overhead to indicate metadata changing with an extra set
     * of events, FeatureStoreEvents will be used to indicate new content is
     * available.
     */
    ...
    /**
     * Gets features of the given type that pass some query. Different from the
     * method that accepts a type and a filter, this method allows for
    ...
    /**
     * Creates a new type. If this FeatureStore is backed by a persistent store
     * of some kind, then structures corresponding to the given type should be
     ...
     *             incompatible with the persisten store that backs this
     *             FeatureStore.
     */
