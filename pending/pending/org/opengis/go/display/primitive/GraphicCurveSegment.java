...
import org.opengis.spatialschema.coordinate.PointArray;
import org.opengis.spatialschema.primitive.CurveSegment;

/**
 * <code>GraphicCurveSegment</code> defines common abstractions for implementations of 
 * 1-dimensional lines made up of one or more line segments and of 
 * 2-dimensional lines made up of a closed set of three or more line segments.
 * The isClosed() method provides the distinction.
 * 
...
public interface GraphicCurveSegment extends Graphic {
     ...
     * Value is acquired from the underlying LineString geometry for this <code>Graphic</code>.
     ...
     * Value is set on the underlying LineString geometry for this <code>Graphic</code>.
     ...
     * positions.
     * Value is deleted on the underlying LineString geometry for this <code>Graphic</code>.
     ...
     * of positions.
     * Value is inserted on the underlying LineString geometry for this <code>Graphic</code>.
