...
public strictfp class GIGS3004Generator extends TestMethodGenerator {
    ...
    static {
        ...
        assertNull(m.put("GIGS geodetic datum A",  "testGeocentric_A"));
        assertNull(m.put("GIGS geodetic datum B",  "testGeographic3D_B"));
        assertNull(m.put("GIGS geodetic datum B′", "testGeographic_B"));
        assertNull(m.put("GIGS geodetic datum C",  "testGeographic3D_C"));
        assertNull(m.put("GIGS geodetic datum C′", "testGeographic_C"));
        assertNull(m.put("GIGS geodetic datum D",  "testGeographic_D"));
        assertNull(m.put("GIGS geodetic datum E",  "testGeographic3D_E"));
        assertNull(m.put("GIGS geodetic datum E'", "testGeographic_E"));
        assertNull(m.put("GIGS geodetic datum F",  "testGeographic_F"));
        assertNull(m.put("GIGS geodetic datum G",  "testGeographic_G"));
        assertNull(m.put("GIGS geodetic datum H",  "testGeographic_H"));
        assertNull(m.put("GIGS geodetic datum J",  "testGeographic_J"));
        assertNull(m.put("GIGS geodetic datum J′", "testGeographic_J1"));
        assertNull(m.put("GIGS geodetic datum J″", "testGeographic_J2"));
        assertNull(m.put("GIGS geodetic datum J‴", "testGeographic_J3"));
        assertNull(m.put("GIGS geodetic datum K",  "testGeographic_K"));
        assertNull(m.put("GIGS geodetic datum L",  "testGeographic_L"));
        assertNull(m.put("GIGS geodetic datum M",  "testGeographic_M"));
        assertNull(m.put("GIGS geodetic datum T",  "testGeographic_T"));
        assertNull(m.put("GIGS geodetic datum X",  "testGeographic_X"));
        assertNull(m.put("GIGS geodetic datum X′", "testGeographic_X1"));
        assertNull(m.put("GIGS geodetic datum Y",  "testGeographic_Y"));
        assertNull(m.put("GIGS geodetic datum Z",  "testGeographic_Z"));
        assertNull(m.put("GIGS geodetic datum AA", "testGeographic_AA"));
        assertNull(m.put("GIGS geodetic datum BB", "testGeographic_BB"));
        assertNull(m.put("GIGS geodetic datum CC", "testGeographic_CC"));
        assertNull(m.put("GIGS geodetic datum DD", "testGeographic_DD"));
        assertNull(m.put("GIGS geodetic datum EE", "testGeographic_EE"));
        assertNull(m.put("GIGS geodetic datum FF", "testGeographic_FF"));
        assertNull(m.put("GIGS geodetic datum HH", "testGeographic_HH"));
        assertNull(m.put("GIGS geodetic datum ZZ", "testGeographic_ZZ"));
