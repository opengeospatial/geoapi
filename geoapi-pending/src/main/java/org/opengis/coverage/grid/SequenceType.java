...
public class SequenceType extends CodeList<SequenceType> {
     ...
     */
    private static final List<SequenceType> VALUES = initialValues(
        // Inline assignments for getting compiler error if a field is missing or duplicated.
        LINEAR          = new SequenceType("LINEAR"),
        BOUSTROPHEDONIC = new SequenceType("BOUSTROPHEDONIC"),
        CANTOR_DIAGONAL = new SequenceType("CANTOR_DIAGONAL"),
        SPIRAL          = new SequenceType("SPIRAL"),
        MORTON          = new SequenceType("MORTON"),
        HILBERT         = new SequenceType("HILBERT"));
    ...
    /**
     * Returns the sequence type that matches the given name, or returns a new value if there is no match.
    ...
    public static SequenceType valueOf(String code) {
        return valueOf(VALUES, code, SequenceType::new);
    }
}
